#include "co_bootstrapping_converter.h"

CoBootstrappingConverter::CoBootstrappingConverter(std::string input_dag_file_path, std::string input_lgr_file_path)
{
...
void CoBootstrappingConverter::remove_unnecessary_bootstrapped_results()
{
    int num_removed = 0;
...
bool CoBootstrappingConverter::no_path_relies_on_parent_child_bootstrapping_pair(OperationPtr &parent, OperationPtr &child)
{
...
bool CoBootstrappingConverter::path_relies_on_parent_child_bootstrapping_pair(OperationList &path, OperationPtr &parent, OperationPtr &child)
{
...
void CoBootstrappingConverter::write_selective_lgr_file(std::string output_lgr_file_path)
{
...
int main(int argc, char *argv[])
{
    ...
    auto limited_to_selective_converter =
        CoBootstrappingConverter(input_dag_file_path, input_lgr_file_path);
