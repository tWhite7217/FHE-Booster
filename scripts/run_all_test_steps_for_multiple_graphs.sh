...
./scripts/run_sched_all_heuristics_for_multiple_graphs.sh $first_graph_num $last_graph_num $num_cores $bootstrap_levels $initial_levels $first_save_num $last_save_num