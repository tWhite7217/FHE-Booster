...
./scripts/list_schedule_multiple.sh min_bootstrapping.lgr $first_graph_num $last_graph_num min_bootstrapping limited $levels $num_cores
./scripts/convert_multiple_to_selective.sh min_bootstrapping bootstrap_sets min_bootstrapping $first_graph_num $last_graph_num $levels
...
echo ./scripts/generate_bootstrap_sets_for_multiple_graphs.sh $first_graph_num $last_graph_num $levels $segments_weight $slack_weight $urgency_weight
...
do
    ...
    echo ./scripts/convert_multiple_to_selective.sh $first_graph_num $last_graph_num $heuristic_name $levels
