...
#Usage <script_name> <first_graph_num> <last_graph_num> <heuristic_name> <sched_name> <num_cores> <num_levels> <initial_levels> <engine_options>
...
do
    sched_file=./results/random_graph$i/b${num_levels}_i${initial_levels}/${heuristic_name}/${num_cores}_cores/rg${i}_${sched_name}
