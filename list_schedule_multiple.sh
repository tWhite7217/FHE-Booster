...
do
    ...
    ./CPP_code/list_scheduler DDGs/random_graph$i/random_graph$i.txt $source_lgr$source_lgr_suffix results/random_graph$i/rg${i}_list_$5${result_file_suffix}.lgr $4
